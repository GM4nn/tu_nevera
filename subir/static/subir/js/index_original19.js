function ponerboton(condicional){
    
    if(condicional=='dejar de seguir'){
        
        var elide=document.getElementById("liseguir")
        
        
        parent.removeChild(elide)
...
function poner_usuario(){
    ...
    var lol = document.getElementById("idusuario").value
    document.getElementById("id_user").value=lol
}
...
function verificar(){
    ...
    if (!rFilter.test(oFile.type)) {
            document.getElementById("verificardato").disabled=true
            document.getElementById("verificar").innerHTML='Selecciona un archivo de formato de imagen'
            return;
        ...
        document.getElementById("verificardato").disabled=false
...
const instancia=new Vue({
    ...
    data:{
        ...
        {id:18,esconder:false,mostrar:true,nombre:'platano',fotito:'../../static/subir/img/frutas/platano.png'}   
        ],
    ...
    {id:7,esconder:false,mostrar:true,nombre:'champiñon',fotito:'../../static/subir/img/vegetales/hongo.png'},
    ...
    {id:15,esconder:false,mostrar:true,nombre:'zanahoria',fotito:'../../static/subir/img/vegetales/zanahoria.png'},
        ...
        {id:9,esconder:false,mostrar:true,nombre:'trucha',fotito:'../../static/subir/img/mariscos/trucha.png'}, 
        ...
        condimentos_especies:[
            {id:0,esconder:false,mostrar:true,nombre:'aceite',fotito:'../../static/subir/img/especias y condimentos/aceite.png'},
            {id:1,esconder:false,mostrar:true,nombre:'agua',fotito:'../../static/subir/img/especias y condimentos/Agua.png'},
            {id:2,esconder:false,mostrar:true,nombre:'albahaca',fotito:'../../static/subir/img/especias y condimentos/albahaca.png'},
            {id:3,esconder:false,mostrar:true,nombre:'almendras',fotito:'../../static/subir/img/especias y condimentos/almendras.png'},
            {id:4,esconder:false,mostrar:true,nombre:'apio',fotito:'../../static/subir/img/especias y condimentos/apio.png'},
            {id:5,esconder:false,mostrar:true,nombre:'arroz',fotito:'../../static/subir/img/especias y condimentos/arroz.png'},
            {id:6,esconder:false,mostrar:true,nombre:'azafran',fotito:'../../static/subir/img/especias y condimentos/azafran.png'},
            {id:7,esconder:false,mostrar:true,nombre:'azucar morena',fotito:'../../static/subir/img/especias y condimentos/Azucar Morena.png'},
            {id:8,esconder:false,mostrar:true,nombre:'azucar',fotito:'../../static/subir/img/especias y condimentos/azucar.png'},
            {id:9,esconder:false,mostrar:true,nombre:'cafe',fotito:'../../static/subir/img/especias y condimentos/cafe.png'},
            {id:10,esconder:false,mostrar:true,nombre:'canela',fotito:'../../static/subir/img/especias y condimentos/canela.png'},
            {id:11,esconder:false,mostrar:true,nombre:'chocolate',fotito:'../../static/subir/img/especias y condimentos/chocolate.png'},
            {id:12,esconder:false,mostrar:true,nombre:'cilantro',fotito:'../../static/subir/img/especias y condimentos/cilantro.png'},
            {id:13,esconder:false,mostrar:true,nombre:'comino',fotito:'../../static/subir/img/especias y condimentos/comino.png'},
            {id:14,esconder:false,mostrar:true,nombre:'frijoles',fotito:'../../static/subir/img/especias y condimentos/frijoles.png'},
            {id:15,esconder:false,mostrar:true,nombre:'jengibre',fotito:'../../static/subir/img/especias y condimentos/jengibre.png'},
            {id:16,esconder:false,mostrar:true,nombre:'limon',fotito:'../../static/subir/img/especias y condimentos/LEMON.png'},
            {id:17,esconder:false,mostrar:true,nombre:'menta',fotito:'../../static/subir/img/especias y condimentos/menta.png'},
            {id:18,esconder:false,mostrar:true,nombre:'miel',fotito:'../../static/subir/img/especias y condimentos/miel.png'},
            {id:19,esconder:false,mostrar:true,nombre:'nueces',fotito:'../../static/subir/img/especias y condimentos/nueces.png'},
            {id:20,esconder:false,mostrar:true,nombre:'oregano',fotito:'../../static/subir/img/especias y condimentos/oregano.png'},
            {id:21,esconder:false,mostrar:true,nombre:'perejil',fotito:'../../static/subir/img/especias y condimentos/perejil.png'},
            {id:22,esconder:false,mostrar:true,nombre:'pimienta',fotito:'../../static/subir/img/especias y condimentos/pimienta.png'},
            {id:23,esconder:false,mostrar:true,nombre:'romero',fotito:'../../static/subir/img/especias y condimentos/romero.png'},
            {id:24,esconder:false,mostrar:true,nombre:'sal',fotito:'../../static/subir/img/especias y condimentos/sal.png'},
            {id:25,esconder:false,mostrar:true,nombre:'tomillo',fotito:'../../static/subir/img/especias y condimentos/tomillo.png'},
            {id:26,esconder:false,mostrar:true,nombre:'vainilla',fotito:'../../static/subir/img/especias y condimentos/vainilla.png'},
            {id:27,esconder:false,mostrar:true,nombre:'vinagre',fotito:'../../static/subir/img/especias y condimentos/vinagre.png'},
            {id:28,esconder:false,mostrar:true,nombre:'whiskie',fotito:'../../static/subir/img/especias y condimentos/Vino.png'},
            
            
        ],
        
        salsas:[
           {id:0,esconder:false,mostrar:true,nombre:'boloñesa',fotito:'../../static/subir/img/salsas/boloniesa.png'},  
           {id:1,esconder:false,mostrar:true,nombre:'chantilly',fotito:'../../static/subir/img/salsas/chantilly.png'},  
           {id:2,esconder:false,mostrar:true,nombre:'guacamole',fotito:'../../static/subir/img/salsas/guacamole.png'},  
           {id:3,esconder:false,mostrar:true,nombre:'mayonesa',fotito:'../../static/subir/img/salsas/mayonesa.png'},  
           {id:4,esconder:false,mostrar:true,nombre:'mermelada',fotito:'../../static/subir/img/salsas/mermelada.png'},  
           {id:5,esconder:false,mostrar:true,nombre:'mostaza',fotito:'../../static/subir/img/salsas/mostaza.png'}, {id:6,esconder:false,mostrar:true,nombre:'napolitana',fotito:'../../static/subir/img/salsas/napolitana.png'},  
           {id:7,esconder:false,mostrar:true,nombre:'salsa agridulce',fotito:'../../static/subir/img/salsas/salsa-agridulce.png'},  
            
           {id:8,esconder:false,mostrar:true,nombre:'salsa de chocolate',fotito:'../../static/subir/img/salsas/salsa-de-chocolate.png'},  
            
           {id:9,esconder:false,mostrar:true,nombre:'salsa de fresa',fotito:'../../static/subir/img/salsas/salsa-de-fresa.png'}, 
            
           {id:10,esconder:false,mostrar:true,nombre:'salsa de queso',fotito:'../../static/subir/img/salsas/salsa-de-queso.png'},
            
           {id:11,esconder:false,mostrar:true,nombre:'salsa de tomate',fotito:'../../static/subir/img/salsas/salsa-de-tomate.png'}, 
            
           {id:12,esconder:false,mostrar:true,nombre:'salsa rosada',fotito:'../../static/subir/img/salsas/salsa-rosada.png'},  
            
           {id:0,esconder:false,mostrar:true,nombre:'vinagreta',fotito:'../../static/subir/img/salsas/vinagreta.png'}
        ],
  ...
  mounted() {
    ...
    methods:{
        editarcampos(){
          alert("editando campos")  
        },
        albunes(seccion){
            document.getElementById("albuminput").value=seccion
        },
        ingsearch(){
            ...
            var valor3 = document.getElementById("buscaringren3").value
                 ...
                 var listalista=[this.frutas,this.listaing,this.mariscos,this.carnes,this.lacteos,this.panaderia,this.condimentos_especies,this.salsas]
